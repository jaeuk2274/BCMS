...
<html>
	<head>
	    ...
	    <script>
 	        function sharNmeCardHistrSelectViewForm(nmeCardHistrSeq) { //명함 변경내역 상세보기 			
 	        	var nmeCardInfo = document.nmeCardInfo;   
		        
		        nmeCardInfo.nmeCardHistrSeq.value = nmeCardHistrSeq;
		        nmeCardInfo.action = "/sharNmeCardHistrSelectViewForm.do" ;		         
		        nmeCardInfo.submit() ;			    
			}
			...
			<table class="table " id="checkboxTestTbl" style="border:1px; margin-left: auto; margin-right: auto;" border="1">
				...
				<c:forEach var="selectNmeCardHistrList" items="${selectNmeCardHistrList}" varStatus="status">
					<tr style="text-align:center">
						...
						<td style="text-align:center; vertical-align:middle"><a href="javascript:sharNmeCardHistrSelectViewForm(${selectNmeCardHistrList.nmeCardHistrSeq})"><c:out value="${selectNmeCardHistrList.nmeCardHistrUpdateCol}"/></a></td>

...
<html>
	...
	<body onload="cutInfo()">
		<c:choose>
			<c:when test="${selectNmeCardView.sharUseAtBinType == 'N' && selectNmeCardView.sharType == 'Y'}">
				<c:import url="/sharNmeCardSelectForm.do"/>
			</c:when>
			<c:when  test="${selectNmeCardView.sharUseAtBinType == 'B' && selectNmeCardView.sharType == 'B'}">
				<c:import url="/sharNmeCardBinSelectForm.do"/>
			</c:when>
		</c:choose>
		<div class="body">
			<form name="nmeCardView" method="post">
				<input type="hidden" name="sharSeq" value="${selectNmeCardView.sharSeq}">
						...
						<table class="table" style="width:100%;">
							...
							<tr>
								<td colspan="4" style="border-top-width: 0px;">
									<a href="javascript:sexTr()" style="float:right"><font id="sexTab">▼</font></a>								
								</td>
							</tr>
							<!-- 회사 입력란 -->									
							<tr>
							...
							<tr>
								<td colspan="4" style="border-top-width: 0px;">
									<a href="javascript:numTr()" style="float:right"><font id="numTab">▼</font></a>								
								</td>
							</tr>
							<!-- 네트워크 입력란 -->
							<tr>
		...
		<div>
			<c:choose>
				<c:when test="${selectNmeCardView.sharUseAtBinType == 'N'}">
					<c:import url="/sharNmeCardButtonForm.do"/>
				</c:when>
				<c:otherwise>

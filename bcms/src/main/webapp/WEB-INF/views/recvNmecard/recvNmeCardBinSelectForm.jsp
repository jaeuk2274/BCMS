...
<html>
	<head>
		<meta charset="UTF-8">
		<title>BCMS - 받은 명함 리스트 휴지통</title>
		<script src="http://code.jquery.com/jquery-latest.min.js"></script>		
		<script type="text/javascript">

			function recvNmeCardSelectViewForm(nmeCardSeq) { //명함 상세보기
			...
			function arrayNmeCard(page) { //명함 정렬보기
				...
				document.nmeCardInfo.searchWrd.value = searchWrd;
				document.nmeCardInfo.searchAry.value = searchAry;
				document.nmeCardInfo.action = "/recvNmeCardBinSelectForm.do";
				document.nmeCardInfo.submit();
			}
			...
			function deleteRecvNmeCardBin(){ //명함 체크박스 삭제
				var nmeCardSeq ="";
		...
		<div class="body" style="margin-bottom:3%">
			<div class ="wrapper">
				...
				<div class="card">
					...
					<button class="btn btn-default" style="margin-left:7px;" onclick="location.href='/recvNmeCardBinSelectForm.do'"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span></button>				
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="#" onclick="javascript:deleteRecvNmeCardBin()">삭제</a></li>
						</ul>
					</div>
					</h3>
					<article>

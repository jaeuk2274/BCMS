		...
		<form name="update" method="POST">
			<div class="wrapper" style="width:599px; margin-left:1px">
				...
				<table class="table table-bordered" border=1 ">
					...
					<tr>
							<th style="text-align:center;width:104px">구분</th>
						<td>
							<select class="form-control" name="comnctnType" id="t" style="display:inline-block;" onchange="javascript:hi()">
					            <c:if test="${selectNmeCardComnctnView.comnctnType == 'meeting'}">
					            	<option value="meeting" selected>meeting</option>
					            	<option value="memo">memo</option>
					            </c:if>
					            <c:if test="${selectNmeCardComnctnView.comnctnType == 'memo'}">
					...
					<div id="test" style="display:block;">
						<table class="table table-bordered" border=1 style=" margin-top:-20px">
								<tr>
									...
									<td><input class="form-control" type="text" id="atnd" name="comnctnAtnd" value="${selectNmeCardComnctnView.comnctnAtnd}"></td>
								</tr>
								<tr>
									<td><input class="form-control" type="text" id="noAtnd" name="comnctnNoAtnd" value="${selectNmeCardComnctnView.comnctnNoAtnd}"></td>
								</tr>
						</table>
					</div>
					<table class="table table-bordered" border=1 style="margin-top:-20px">
							...
							<tr>
								<td colspan=2><textarea rows="15" cols="79" name="comnctnContn" >${selectNmeCardComnctnView.comnctnContn}</textarea></td>
							</tr>
					</table>
